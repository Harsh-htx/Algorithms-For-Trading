...
access_token = "vYnm9fkOdL4YADkLpxfd1N8fwqj4mf0_FNDBsIaOq1k.4JUeLh_8nGMDp3GLOToNBVdFjhhUQXqU9FQHIPGVp3I"
...
# print(f" Exchange:{message['exchange']}, Token:{message['token']}, Symbol:{message['instrument'].symbol}, Lot_Size:{message['instrument'].lot_size}, LTP:{message['ltp']}, High:{message['high']}, Low:{message['low']}, Volume:{message['volume']}, Time:{datetime.datetime.fromtimestamp(message['exchange_time_stamp'])} ")
	...
	# risk_per_trade = 500
	target = 10.0 #round(reward_per_trade/quantity, 1)
	stoploss = 5.0 #round(risk_per_trade/quantity, 1)
...
# watchlist = ["ZEEL", "ITC", "IBULHSGFIN", "SBIN", "DLF", "RBLBANK", "POWERGRID", "EXIDEIND", "PETRONET", "APOLLOTYRE", "INDUSTOWER", "AMBUJACEM", "HINDALCO", "JINDALSTEL", "TORNTPOWER", "BANDHANBNK"]
while True:
